...
String st;
File mFolder =new File("C:\\Users\\91800\\Desktop\\BUNNY");
mFolder.mkdir();
String location = "C:\\Users\\91800\\Desktop\\BUNNY";
System.out.println("Welcome to Virtual Key for Repositories inJAVA\n\n");
System.out.println("Press Enter to continue...");
 ...
 switch(choice) {
 case 1:
 File Fobj = new File("C:\\Users\\91800\\Desktop\\BUNNY");
File Farray[] = Fobj.listFiles();
 ...
 switch(OPchoice) {
 case 1:
 System.out.println("Please Enter the Foldername");
 String str1 = sc.next();
 File addfolder = new File(location+"\\"+str1);
 if(addfolder.exists()) {
 System.out.println("Already exits !! PleaseEnter Again\n");
 }
 else {
 addfolder.mkdir();
 System.out.println("!!Your Folder iscreated!!!\n");
 }
 break;
 case 2:
 System.out.println("Please Enter the File name withextension");
 String str2 = sc.next();
 ...
 System.out.println("!!Your fileis created!!!\n");
 }catch(IOException e) {
 e.printStackTrace();
 }
 }
 ...
 break;
 default:
 System.out.println("Please Enter CorrectValue!!!!!\n");
 ...
 st = sc.next();
 File fsearch = new File("C:\\Users\\91800\\Desktop\\BUNNY");
